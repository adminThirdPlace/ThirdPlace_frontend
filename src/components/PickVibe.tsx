...
/* ---------- swap with live data ---------- */
const events = [
  { src: "/a.PNG",           title: "Sunset & Walk by the lake",  location: "MG Road, BLR"      },
  { src: "/b.PNG",           title: "Pitch and Pair",  location: "MG Road, BLR"      },
  { src: "/c.PNG",           title: "Listening Room",  location: "MG Road, BLR"      },
