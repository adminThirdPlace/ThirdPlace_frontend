...
const events = [
  ...
  { src: "/sangeet.JPG",                 title: "Sangeet Social",           location: "Indiranagar, BLR"  },
  { src: "/salsa.JPG",                   title: "Salsa Socials Soirée",     location: "HSR Layout, BLR"   },
  { src: "/Drunk bowling.JPG",           title: "Drunk Bowling",            location: "MG Road, BLR"      },
